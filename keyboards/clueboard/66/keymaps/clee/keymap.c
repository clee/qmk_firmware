...
[_BL] = CLEEOUT(
  ...
  KC_LCTL,        KC_LALT,KC_LGUI,        KC_BSPC,FNSPC,                          KC_RGUI,KC_RALT,      KC_RCTL ,KC_LEFT,KC_DOWN,KC_RGHT
),

  /* Keymap _FL: Function Layer */
[_FL] = CLEEOUT(
  _______, KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10, KC_F11, KC_F12,_______,_______,         KC_VOLU, \
  _______, KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,   KC_9,   KC_0,  _______,_______,KC_MUTE,                 KC_VOLD, \
  _______,_______,_______,_______,_______,_______,KC_LEFT,KC_DOWN,KC_UP  ,KC_RGHT,_______,_______,    _______,                             \
  _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,        _______,                KC_PGUP,         \
  _______,        _______,_______,        KC_DEL, _______,                        _______,_______,        MO(_CL),KC_HOME,KC_PGDN,KC_END
),
